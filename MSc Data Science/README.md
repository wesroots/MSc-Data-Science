...
All changes made locally in Obsidian are automatically committed and pushed to this GitHub repository using the integrated **Git Obsidian plugin**, ensuring continuous synchronisation between local and remote versions.

---

### Each .md lecture note type begins with a short description at the top of the page unless specified otherwise.
...
- Progress will be made where possible during term time, with increased emphasis during term breaks, acting as supplemental learning and experience without hindering MSc progress and performance.
